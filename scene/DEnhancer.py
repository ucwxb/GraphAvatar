...
class DEnhancer(nn.Module):
    ...
    def __init__(self, n_in_colors, scale, num_feat=64, num_block=5, num_grow_ch=32, num_cond=1, dswise=False):
        ...
        self.CondNet = nn.Sequential(
            nn.Conv2d(num_cond, 16, 3, 1, 1), nn.LeakyReLU(0.2, True),
            nn.Conv2d(16, 16, 1), nn.LeakyReLU(0.2, True),
            nn.Conv2d(16, num_grow_ch, 1))
